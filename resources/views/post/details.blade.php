...
<div class="main-container">
	...
	'layouts.inc.advertising.top'], ['paddingTopExists' => (isset($paddingTopExists)) ? $paddingTopExists : false])
	<?php
	...
	<div class="container">
				...
				<div class="inner inner-box items-details-wrapper pb-0">
					<h2 class="enable-long-words">
						...
						<i class="icon-ok-circled tooltipHere"
							style="color: {{ $post->latestPayment->package->ribbon }};" title="" data-placement="right"
							data-toggle="tooltip"
					...
					<span class="info-row">
						...
						<span
							class="category">{{ (!empty($post->category->parent)) ? $post->category->parent->name : $post->category->name }}</span>
						-&nbsp;
						<span class="item-location"><i class="fas fa-map-marker-alt"></i> {{ $post->city->name }}
						</span> -&nbsp;
						<span class="category">
							<i class="icon-eye-3"></i>&nbsp;
							{{ \App\Helpers\Number::short($post->visits) }}
					...
					<div class="items-details">
						<ul class="nav nav-tabs" id="itemsDetailsTabs" role="tablist">
							...
							@if (config('plugins.reviews.installed'))
							<li class="nav-item">
								<a class="nav-link" id="item-{{ config('plugins.reviews.name') }}-tab" data-toggle="tab"
									href="#item-{{ config('plugins.reviews.name') }}" role="tab"
							...
							<div class="tab-pane show active" id="item-details" role="tabpanel"
								...
								<div class="row">
									<div
										...
										<div class="row">
											<div class="col-12 detail-line-content">
												...
												<video style="
													...
													height: 350px;
												" controls>
													<source src="{{Request::root()}}/public/files/{{ $post->Video}}"
														type="video/mp4">
													<source src="{{Request::root()}}/public/files/{{ $post->Video}}"
														type="video/ogg">
										...
										'post.inc.fields-values', 'post.inc.fields-values'])
					...
					<div class="card card-user-info sidebar-card">
						...
						<div class="card-content">
							...
							<div class="ev-action" {!! $evActionStyle !!}>
								...
								@if (isset($countPackages) and isset($countPaymentMethods) and $countPackages > 0 and
		...
		@includeFirst([config('larapen.core.customizedViewPath') . 'post.inc.compose-message',
		'post.inc.compose-message'])
		@endif
		@endsection
